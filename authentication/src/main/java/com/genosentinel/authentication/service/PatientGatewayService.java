...
public class PatientGatewayService {
	...
	public ResponseEntity<Object> getPatientList() {
		String djangoUrl = "http://clinic-service:3000/genosentinel/clinica/patients";
	...
	public ResponseEntity<Object> getPatientById(Long id) {
		String djangoUrl = "http://clinic-service:3000/genosentinel/clinica/patients/" + id;
		try {
			return restTemplate.exchange(djangoUrl, HttpMethod.GET, null, Object.class);
	...
	public ResponseEntity<Object> searchPatientsByName(String name) {
		...
		String djangoUrl = "http://clinic-service:3000/genosentinel/clinica/patients/search?name=" + encoded;
		return restTemplate.exchange(djangoUrl, HttpMethod.GET, null, Object.class);
	}

	public ResponseEntity<Object> findPatientsByStatus(String status) {
		String djangoUrl = "http://clinic-service:3000/genosentinel/clinica/patients/status/" + status;
		try {
			return restTemplate.exchange(djangoUrl, HttpMethod.GET, null, Object.class);
		} catch (RestClientResponseException e) {
			return ResponseEntity.status(e.getStatusCode()).body(e.getResponseBodyAsString());
	...
	public ResponseEntity<Object> deactivatePatient(Long id) {
		String djangoUrl = "http://clinic-service:3000/genosentinel/clinica/patients/" + id + "/deactivate/";
		try {
