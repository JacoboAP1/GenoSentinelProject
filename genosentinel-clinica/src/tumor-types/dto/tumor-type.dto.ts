...
export class CreateTumorTypeDto {
    ...
    @ApiProperty({ example: 'Tumor maligno del tejido mamario', description: 'Descripción del tumor', required: false })
    @IsString()
    @IsOptional()
    description?: string;
}
...
export class UpdateTumorTypeDto {
    @ApiProperty({ example: 'Cáncer de Mama Triple Negativo', description: 'Nombre del tipo de tumor', required: false })
    @IsString()
    @IsOptional()
    name?: string;

    @ApiProperty({ example: 'Glándulas Mamarias', description: 'Sistema corporal afectado', required: false })
    @IsString()
    @IsOptional()
    systemAffected?: string;

    @ApiProperty({ example: 'Subtipo agresivo de cáncer de mama', description: 'Descripción del tumor', required: false })
    @IsString()
    @IsOptional()
    description?: string;
}
...
/**
 * DTO de respuesta para tipo de tumor
 */
