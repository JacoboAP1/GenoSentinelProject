...
export class PatientsController {
  ...
  @ApiOperation({
    ...
    description: 'Registra un nuevo paciente oncológico en el sistema',
  })
  @ApiResponse({
    status: 201,
  ...
  async create(
    @Body() createPatientDto: CreatePatientDtoIn,
  ...
  @ApiOperation({
    ...
    description: 'Retorna la lista completa de pacientes registrados',
  })
  @ApiResponse({
    status: 200,
  ...
  @Get('status/:status')
  @ApiOperation({
    summary: 'Obtener pacientes por estado',
  ...
  async update(
    @Param('id') id: number,
    @Body() updatePatientDto: UpdatePatientDtoIn,
  ): Promise<PatientDtoOut> {
